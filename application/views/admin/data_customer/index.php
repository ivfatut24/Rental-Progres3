	...
	<aside class="right-side">
		...
		<section class="content">
			...
			<div class="row">
			  ...
			  <div class="col-lg-4">
				  <a href="<?php echo base_url('admin/customer/create/')?>" class="btn btn-sm btn-warning">Tambah Customer <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
			<!-- /.row -->
			<br/>
						  ...
						  <table id="table" class="table table-hover table-bordered">
							  <thead>
								  <tr>
									...
									<th><center>Nama Customer </i></center></th>
