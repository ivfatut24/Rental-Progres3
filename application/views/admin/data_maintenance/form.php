...
<aside class="right-side ">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Input Data Maintenance</li>
		</ol>
	</section>
			...
			<div class="col-lg-12">
				<div class="panel panel-success">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-user"></i> Input Data Maintenance </h3> 
					</div>
							...
							<div class="form-horizontal style-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<a href="<?php echo base_url('admin/maintenance')?>" class="btn btn-sm btn-danger">Batal </a>
									</div>
								</div>
							</div>
						</div>
